...
def argsparser():
    ...
    parser.add_argument('--input', type=str, default='../datasets/test_Xray', help='path of input')
    parser.add_argument('--bmodel', type=str, default='../models/bm1684/yolov8s_Xray_fp32_1b.bmodel', help='path of bmodel')
